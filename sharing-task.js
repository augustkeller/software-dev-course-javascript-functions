...
console.log(makeBadge("Alice", "Speaker"));
...
function eventCost(guests, cost){
    let price = (guests * cost);
    if (guests > 100) {
        return `Total Cost: ${price *= .9}`;
    } else {
        return `Total Cost: ${price}`
    }
}
console.log(eventCost(110, 10));
console.log(eventCost(90, 10));
